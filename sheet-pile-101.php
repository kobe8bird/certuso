...
<body>
    ...
    <div class="headerContentBgBoxed hidden"></div>
        ...
        <section id="noslider" class="sixteen columns headerContent" data-layout="blur">
            ...
            <div class="headerContentContainer">
               <div class="pageTitle">Cold Formed <span class="highlight">Sheet Pile 101</span></div>
               <div class="breadCrumbs"><a href="/">Home</a> / <span>Our Products</span> / <span class="highlight">Sheet Pile 101</span></div>
            </div>
   ...
   <section class="row offset-by-one">
                 ...
                 <article class="row">
                  <h2>Sheet Pile 101</h2>
                 
                  <p>A sheet pile is a pressed or molded sheet metal that is commonly used as an earth
                    retention and excavation support. It has been classified as
                    a flexible retaining system and can be used for several
                    purposes such as: large waterfront structures, erosion
                    protection, stabilizing ground slopes, flood control, cofferdams,
                    shoring wall of trenches and excavations, and for any below
                    grade projects requiring retention walls.</p>

                  <p>Sheet pile walls are installed by laying out a sequence of sheet
                    pile sections that are interlocked and are driven using a driving or
                    vibrating motion. It can be used as a temporary structure where
                    supported excavation is needed, or it can be permanently installed
                    as an economical way of building retaining walls for ports, wharfs,
                    deepening of rivers, bridges, and basement excavations.</p>
               </article>
      ...
      <section class="sixteen columns offset-by-one">
        <article class="onethird row odd">
            <img src="http://placehold.it/306x165?text=www.certuso.com">
            <h4>Flood Control</h4>
         ...
         <article class="onethird row">
            <img src="http://placehold.it/306x165?text=www.certuso.com">
            <h4>Slope Protection</h4>
            <div class="lineSeparator"></div>
              <p>Suspendisse potenti. Sed placerat maru mauris quis arcu hendrerit aliquam geni.</p>
            <div class="lineSeparator"></div>
         </article>
         
         <article class="onethird row odd last">
            <img src="http://placehold.it/306x165?text=www.certuso.com">
            <h4>Cut off and Containment</h4>
            <div class="lineSeparator"></div>
              <p>Suspendisse potenti. Sed placerat maru mauris quis arcu hendrerit aliquam geni.</p>
            <div class="lineSeparator"></div>
         </article>
