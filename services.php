    ...
    <div class="headerContentBgBoxed hidden"></div>
        ...
        <section id="noslider" class="sixteen columns headerContent" data-layout="blur">
            ...
            <div class="headerContentContainer">
               <div class="pageTitle">Service <span class="highlight">Offered</span></div>
               <div class="breadCrumbs"><a href="/">Home</a> / <span class="highlight">Service us</span></div>
            </div>
        ...
        <section class="sixteen columns offset-by-one">
           ...
           <div class="sectionHeader row">
                ...
                <div class="sectionHeadingWrap">
                    <span class="sectionHeading">METHODS</span>
                </div>
                       
           </div>

           <article class="row">
              <p>We offer both Hot Rolled and Cold Formed steel sheet piles
                  alongside with full customization on steel grades, lengths,
                  thickness and special profiles for your project requirements.
                  Our company can provide design assistance to your
                  engineering or consultancy team to cost optimize and tailor a
                  special sheet pile size for projects. Our sheet piles are
                  competitively priced and produced to the highest quality. They
                  are also readily stocked in the Philippines to provide fast
                  response time according to the needs of your projects.</p>
           </article>
        </section>
       ...
       <!-- Isotope filters
        ...
        <section class="sixteen columns offset-by-one">
           ...
           <div class="sectionHeader row">
                ...
                <div class="sectionHeadingWrap">
                    <span class="sectionHeading">Illustration / video of Vibro Hammer Pile driving</span>
                </div>
       ...
       <!-- Isotope filters
        ...
        <section class="sixteen columns offset-by-one">
           ...
           <div class="sectionHeader row">
                ...
                <div class="sectionHeadingWrap">
                    <span class="sectionHeading">Advantages </span>
                </div>
        ...
        <section class="sixteen columns offset-by-one">
           ...
           <div class="sectionHeader row">
                ...
                <div class="sectionHeadingWrap">
                    <span class="sectionHeading">PROJECTS</span>
                </div>
        ...
        <section class="isotopeFilters clearfix">
          ...
          <ul class="option-set clearfix" data-option-key="filter">
              <li><a href="#" data-filter=".motion">Pangi</a></li>
              <li><a href="#" data-filter=".illustration">Lupon</a></li>
        ...
        <section class="isotopeContainer portfolio left-twenty">
                    ...
                    <div class="element onethird illustration">
                        ...
                        <div class="portfolioImage">
                            <a class="jackbox" data-group="work1" data-thumbTooltip = "Image Title" data-title="Title"  data-description="#description_1" href="images/portfolio/1.jpg">
                               <div class="jackbox-hover jackbox-hover-blur jackbox-hover-magnify"></div>
                               <img width="306" height="170" src="images/portfolio/thumbs3/1.jpg" alt="" />
            ...
            <!-- Sample div used as an item's description, will only appear inside JackBox -->
                    ...
                    <div class="element onethird motion">
                      
                      <div class="portfolioImage">
                            <a class="jackbox" data-group="work2" data-thumbTooltip = "Image Title" data-title="Title"  data-description="#description_2" href="http://vimeo.com/24302498">
                               <div class="jackbox-hover jackbox-hover-blur jackbox-hover-play"></div>
                               <img width="306" height="170" src="images/portfolio/thumbs3/2.jpg" alt="" />
                               <span class="portfolioImageOver transparent"></span>
                           </a>
                        </div>
            ...
            <!-- Sample div used as an item's description, will only appear inside JackBox -->
                    ...
                    <div class="element onethird  motion">
                      ...
                      <div class="portfolioImage">
                            <a class="jackbox" data-group="group_example" data-thumbTooltip = "Cool hair" data-title="Title" href="images/portfolio/5.jpg">
                               <div class="jackbox-hover jackbox-hover-blur jackbox-hover-magnify"></div>
                               <img width="306" height="170" src="images/portfolio/thumbs3/5.jpg" alt="" />
                               <span class="portfolioImageOver transparent"></span>
                           </a>
                      ...
                      <ul class="jackbox-hidden-items">
                        ...
                        <li class="jackbox" data-group="group_example" data-title="Kilogramme" data-description="#description_52" data-href="http://vimeo.com/17516687"></li>
                        <li class="jackbox" data-group="group_example" data-title="Dreamland Sender" data-description="#description_53" data-href="http://vimeo.com/17586987"></li>
                        <li class="jackbox" data-group="group_example" data-title="Google eBooks" data-description="#description_54" data-href="http://vimeo.com/17574435"></li>
                        ...
                        <!-- Sample div used as an item's description, will only appear inside JackBox -->
                        <div class="jackbox-description" id="description_52">
                            <h3>Kilogramme</h3>
                            <a href="#">Link</a> ipsum dolor sit amet, consectetur adipiscing elit. In est metus, tincidunt vitae eleifend sit amet, porta a sapien. Fusce in dolor nec purus facilisis dictum. tincidunt sed quam. 
                        </div>
                        ...
                        <!-- Sample div used as an item's description, will only appear inside JackBox -->
                        <div class="jackbox-description" id="description_53">
                            <h3>Dreamland Sender</h3>
                            <a href="#">Link</a> ipsum dolor sit amet, consectetur adipiscing elit. In est metus, tincidunt vitae eleifend sit amet, porta a sapien. Fusce in dolor nec purus facilisis dictum. tincidunt sed quam. 
                        </div>
                        ...
                        <!-- Sample div used as an item's description, will only appear inside JackBox -->
                        <div class="jackbox-description" id="description_54">
                            <h3>Google Ebooks</h3>
                            <a href="#">Link</a> ipsum dolor sit amet, consectetur adipiscing elit. In est metus, tincidunt vitae eleifend sit amet, porta a sapien. Fusce in dolor nec purus facilisis dictum. tincidunt sed quam. 
                        </div>
