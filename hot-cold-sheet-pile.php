    ...
    <div class="headerContentBgBoxed hidden"></div>
        ...
        <section id="noslider" class="sixteen columns headerContent" data-layout="blur">
            ...
            <div class="headerContentContainer">
               <div class="pageTitle">Hot Rolled <span class="highlight">Sheet Pile</span></div>
               <div class="breadCrumbs"><a href="/">Home</a> / <span class="highlight">Our Products</span> / <span class="highlight">Hot Cold Sheet Pile</span></div>
            </div>
       ...
       <!-- Tag Line
        ...
        <div id="tagLineShadow" class="sixteen columns"></div>
          ...
          <section class="row offset-by-one">
                 ...
                 <article class="row">
                  <h2>Hot Rolled Sheet Pile</h2>
                 
                <p>Hot rolled sheet piles are produced from a beam blank and made at very high temperatures. Because itis molded under extremely hight temperature.,
                  it has more complex, tighter and thicker interlocks which allows for a pile driving under harder ground conditions</p>
               </article>
      ...
      <section class="sixteen columns offset-by-one">
        <article class="onethird row odd">
            <a href="pdf/CERTUSOBROCHURE-min.pdf"><img src="images/hot-rolled/hot1.jpg"></a>
            <h4>Flood Control</h4>
         ...
         <article class="onethird row">
           <a href="pdf/CERTUSOBROCHURE-min.pdf"><img src="images/hot-rolled/hot2.jpg"></a>
         ...
         <article class="onethird row odd last">
            <a href="pdf/CERTUSOBROCHURE-min.pdf"><img src="images/hot-rolled/hot3.jpg"></a>
        ...
        <section class="sixteen columns offset-by-one">
          ...
          <article class="onewhole row">
            <a href="#"><img src="images/hot-rolled/hot4.jpg"></a>
            <a href="#"><img src="images/hot-rolled/hot5.jpg"></a>
            <a href="#"><img src="images/hot-rolled/hot6.jpg"></a>
            <h4>Matrices and Tables</h4>
            <div class="lineSeparator"></div>
              <p>Certuso's hot rolled sheer piles are manufactured in EN 10248 or JIS 5528/5523 standards.</p>
            <div class="lineSeparator"></div>
         </article>
